...
// One tick per edit across the last hour, oldest on the left. Additions rise
// above the line and removals drop below it, on a log scale so a one-word fix
// and a rewritten section are both visible.
  ...
  return (
    ...
    >
      ...
      {edits.map(({ edit, key, revealAt }) => {
        const x = WIDTH * (1 - (clock - revealAt) / WINDOW_MS);
