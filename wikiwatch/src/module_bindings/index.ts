  ...
  articlePreview: __table(
    {
      ...
      constraints: [
        {
          name: "article_preview_page_id_key",
          constraint: "unique",
          columns: ["pageId"],
        },
      ],
  ...
  edit: __table(
    {
      ...
      indexes: [
        ...
        {
          accessor: "in_argument",
          name: "edit_in_argument_idx_btree",
          algorithm: "btree",
          columns: ["inArgument"],
        },
        {
        ...
        {
          accessor: "page_id",
          name: "edit_page_id_idx_btree",
          algorithm: "btree",
          columns: ["pageId"],
        },
        {
          accessor: "rc_id",
          name: "edit_rc_id_idx_btree",
          algorithm: "btree",
          columns: ["rcId"],
        },
      ],
      constraints: [
        { name: "edit_rc_id_key", constraint: "unique", columns: ["rcId"] },
      ],
    },
    EditRow,
  ),
...
const reducersSchema = __reducers(
  __reducerSchema("remark_arguments", RemarkArgumentsReducer),
  __reducerSchema("update_schedulers", UpdateSchedulersReducer),
);
